...
module.exports = app => {
  ...
  router
    ...
    .patch('/user', auth, controller.user.update) // 更新当前用户
    ...
    .delete('/users/:userId/unsubscribe', auth, controller.user.unsubscribe) // 取消用户订阅
    .get('/users/:userId/subscriptions', controller.user.subscriptions) // 获取用户订阅列表
    ...
    .get('/users/:userId/videos', controller.video.getUserVideos) // 获取用户发布的是视频列表
